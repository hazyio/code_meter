...
Future<String?> fetchEssentialApps() async {
  const sources = [
    ...
    "https://cdn.statically.io/gh/hazyio/code_meter@main/site/static/essential_apps.txt",
    'https://raw.githubusercontent.com/hazyio/code_meter/main/site/static/essential_apps.txt',
  ];
